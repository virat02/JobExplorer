# Generated by Django 2.2.7 on 2019-12-11 19:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_uuid', models.UUIDField(default=uuid.UUID('13a8ad2c-7006-4c83-9ba0-930314769096'), editable=False)),
                ...
                ('disliked_by_users', models.ManyToManyField(blank=True, null=True, related_name='job_dislike', through='jobs.Dislikes', to=settings.AUTH_USER_MODEL)),
                ('favourite_users', models.ManyToManyField(blank=True, null=True, through='jobs.Favourites', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Likes',
            fields=[
                ...
                ('job', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='job_like', to='jobs.Job')),
