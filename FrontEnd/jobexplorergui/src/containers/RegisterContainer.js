...
export const dispatcherToPropsMapper = dispatch => ({
    ...
    doRegister: (firstName, lastName, dob, email, username, password, password2, description) =>
        actions.doRegister(dispatch, firstName, lastName, dob, email, username, password, password2, description)
});
